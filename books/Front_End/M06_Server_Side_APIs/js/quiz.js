...
let questions = [
  {
    question: "What does the Fetch API primarily allow you to do?",
    options: ["A)Make network requests to servers", 
              "B)Manage local storage", 
              "C)Create and manage cookies"],
    answer: "A)Make network requests to servers",
  },
  {
    question: "What type of object is returned by the Fetch API?",
    options: ["A)XMLHttpRequest",
              "B)Promise",
              "C)Callback"],
    answer: "B)Promise",
  },
  {
    ...
    answer: "A)Converts an object to a JSON string",
  },
  {
    question: "What happens if you call fetch('https://api.github.com/users') with an incorrect URL?",
    options: [
      "A)It will return an empty object",
      "B) It will throw an error immediately",
      "C) It will resolve with a Response object containing an error status",
    ],
    answer: "C) It will resolve with a Response object containing an error status",
  },
  {
    question: "How do you convert a response body to text using the Fetch API?",
    options: [
      "A)response.text()",
      "B)response.body()",
      "C)response.convertToText()",
    ],
    answer: "A)response.text()",
  },
];
