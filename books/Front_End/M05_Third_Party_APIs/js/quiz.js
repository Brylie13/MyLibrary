...
let questions = [
  {
    question: "How do you attach an event listener to a button in JavaScript?",
    options: ["A)button.addEventListener('click', callback);", 
              "B)button.click(callback);", 
              "C)button.onClick(callback);"],
    answer: "A)button.addEventListener('click', callback);",
  },
  {
    question: "How do you create a button group in Bootstrap?",
    options: ["A)Use the btn-group class",
              "B)Use the button-stack class",
              "C) Use the btn-container class"],
    answer: " A)Use the btn-group class",
  },
  {
    question: "Which method in jQuery UI is used to make an element sortable?",
    options: [
      "A)sortable()",
      "B)arrangeable()",
      "C)sort()",
  ...
  {
    question: "Which jQuery method can be used to stop event propagation?",
    options: [
      "A)stopPropagation()",
      "B)preventDefault()",
      "A)cancelPropagation()",
  ...
  },
  {
    ...
    options: [
      "A)Use the modal() method in jQuery",
      "B)Add the modal class to a div and use JavaScript to trigger it",
      "C) Use the tooltip class",
    ],
    answer: "B)Add the modal class to a div and use JavaScript to trigger it",
  },
];
