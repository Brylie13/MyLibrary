...
let questions = [
  {
    ...
    options: ["A)document.createElement()", 
              "B)document.appendChild()", 
              "C)document.writeElement()"],
    answer: "A)document.createElement()",
  },
  {
    question: "What does the appendChild() method do?",
    options: ["A)It appends text to an HTML element",
              "B)It adds a new child element to an existing parent element",
              "C)It removes a child element from a parent element"],
    answer: " B) It adds a new child element to an existing parent element",
  },
  {
  ...
  {
    question: "Which method will repeatedly call a function at regular intervals?",
    options: [
      "A)setTimeout()",
      "B)setInterval()",
      "C)repeatTimeout()",
